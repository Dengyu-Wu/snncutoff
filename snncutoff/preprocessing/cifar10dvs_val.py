...
train_filename = '/LOCAL/dengyu/dvs_dataset/dvs-cifar10-val/train/{}.pt'
test_filename = '/LOCAL/dengyu/dvs_dataset/dvs-cifar10-val/test/{}.pt'
val_filename = '/LOCAL/dengyu/dvs_dataset/dvs-cifar10-val/val/{}.pt'
...
for root,dirs,files in os.walk('/opt/LOCAL/share/datasets/cifar10_dvs'):
    ...
    sample_for_training = int(sample_num*0.8)
    sample_for_validation = int(sample_num*0.9)
    for names in files:
        names = str(names)
        if names.endswith(".aedat"):
            ...
            if sample_array[_num] < sample_for_training:
                ...
                key_train += 1
            elif  sample_for_training <= sample_array[_num]  and sample_array[_num] < sample_for_validation:
                ...
                for n in range(split_num):
                    ...
                    for subname in class_names:
                        ...
                        if subname == _path[-2]:
                            break
                        num += 1      
                    torch.save([torch.Tensor(_frame), torch.Tensor([num,])],val_filename.format(key_test))
