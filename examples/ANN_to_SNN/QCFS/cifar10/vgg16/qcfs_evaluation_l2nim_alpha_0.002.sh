...
python  ./scripts/evaluation.py \
        ...
        snn-test.model_path=\'/LOCAL2/dengyu/MySNN/easycutoff/outputs/cifar10-vgg16-ann1T4L-qcfsconstrs-l2min-alpha0.002-seed1200-epochs300/cifar10-aideoserver.pth\'
